            ...
            {projects.map((project, i) => (
                <div className='w-screen flex flex-col space-y-5 items-center justify-center flex-shrink-0 snap-center p-20 md:p-44 h-screen'>
                    <motion.img
                        ...
                        viewport={{ once: true }}
                        src='https://www.webdesignerdepot.com/cdn-origin/uploads/2015/11/netflix_devices2.jpg' 
                        alt=''
                        className='md:mb-0 flex-shrink-0 w-56 h-56 md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[300px] sm:pt-0 pt-20 object-contain cursor-pointer'
                    />
